...
if __name__ == "__main__":
    ...
    parser.add_argument("--non-deterministic", action="store_false", dest="deterministic", help="使用随机动作而非确定性动作")

    args = parser.parse_args()

    evaluate_car_racing(args.model_path, args.episodes, args.seed, args.render, args.deterministic)
